 ...
 *
 * webapplib是一系列主要用于类Unix操作系统环境下WEB开发的小型C++类库。
 * 设计目的是通过提供使用简单方便、相对独立的C++类和函数来简化CGI程序开发过程中的常见操作，提高开发效率，降低系统维护与改进的难度，适用于中小型规模WEB系统开发<br><br>
 *
 ...
 *
 * <center>
 * <a href="readme.html">Readme & FAQ</a>
 * 刘立  pilot.cn@gmail.com
 */
